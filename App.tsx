...
const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: 'Bajo el Mar',
    price: 48.00,
    description: 'Llamativo collar de cuentas de cristal azul craquelado con un gran dije metálico de esqueleto de pez con baño de oro colgando del aro frontal.',
    material: 'Cuentas de cristal azul craquelado, espaciadores verdes y dije de pez metálico con baño de oro',
  ...
  },
  {
    ...
    name: 'Sendero de Paz',
    price: 44.00,
    description: 'Elegante collar largo continuo de grandes cuentas de acrílico negro pulido con eslabones de cadena de aluminio dorado en los laterales.',
    material: 'Cuentas de acrílico negro y eslabones de cadena de aluminio dorado',
  ...
  },
  {
    ...
    name: 'Sendero Verde',
    price: 45.00,
    description: 'Collar de cordón de seda verde esmeralda trenzado con un delicado dije de pez de cerámica en tonos verde pastel y azul (diseño de dije fijo, no removible).',
  ...
  },
  {
    ...
    price: 49.00,
    description: 'Alegre collar de cuentas de acrílico blanco pulido con espaciadores en tonos neón naranja y verde, y un dije de pez plano de latón pulido dorado en el centro.',
    material: 'Cuentas de acrílico blanco, espaciadores de cuentas semilla y pez de latón',
  ...
  },
  {
    ...
    name: 'Sol de Otoño',
    price: 45.00,
    description: 'Collar artesanal continuo elaborado con cuentas redondas de acrílico en un tono amarillo mostaza opaco, complementado con sutiles cuentas espaciadoras en azul celeste.',
    material: 'Cuentas de acrílico amarillo mostaza y espaciadores celestes',
  ...
  },
  {
    ...
    price: 55.00,
    description: 'Exclusiva combinación de cuentas de acrílico verde veteado con anillos espaciadores dorados y una magnífica perla barroca de agua dulce en el centro.',
    material: 'Cuentas de acrílico verde jaspeado, anillos de latón dorado y perla barroca cultivada',
  ...
  },
  {
    ...
    name: 'Marea Serena',
    price: 50.00,
    description: 'Hermosa pieza de cuentas de resina color amarillo claro suave combinadas con espaciadores celestes y un colgante en forma de pez enchapado en oro.',
    material: 'Cuentas de resina pulida color amarillo claro, espaciadores celestes y dije de pez enchapado en oro',
  ...
  },
  {
    ...
    price: 53.00,
    description: 'Collar de cordón de seda azul turquesa trenzado con un hermoso dije artesanal de pez de cerámica en color ocre y marrón (diseño de dije fijo, no removible).',
  ...
  },
  {
    ...
    price: 51.00,
    description: 'Llamativo collar de cuentas redondas verdes mate con un gran dije de estrella de mar de acero inoxidable en diseño fijo (dije no removible).',
    material: 'Cuentas de resina verde mate y dije de estrella de mar de acero inoxidable (stainless steel) no removible',
  ...
  },
  {
    ...
    name: 'Luz del Alma',
    price: 47.00,
    description: 'Collar de cordón de seda amarillo mostaza brillante con un dije de pez de cerámica azul y amarillo de acabado rústico (diseño de dije fijo, no removible).',
  ...
  },
  {
    ...
    price: 51.00,
    description: 'Preciosa combinación de cuentas iridiscentes color rosa durazno de brillo boreal con un dije de sol de acero inoxidable (stainless steel) de diseño removible.',
    material: 'Cuentas de acrílico rosadas iridiscentes y dije de sol de acero inoxidable (stainless steel)',
  ...
  },
  {
    ...
    name: 'Rosa de Sarón',
    price: 58.00,
    description: 'Collar continuo de cuentas de acrílico color fucsia intenso y vibrante con una gran perla de río blanca asimétrica en el centro. Diseño continuo de alta costura.',
    material: 'Cuentas de acrílico fucsia y perla barroca natural de agua dulce',
  ...
  },
  {
    ...
    name: 'Corona de Gozo',
    price: 60.00,
    description: 'Collar continuo que combina cuentas de acrílico amarillo brillante con tres cuentas de tamaño mayor en amarillo mostaza mate en el centro.',
    material: 'Cuentas de acrílico amarillo brillante y mate con espaciadores celestes',
  ...
  },
  {
    ...
    name: 'Amor Celestial',
    price: 50.00,
    description: 'Collar de cuentas planas ovaladas en color magenta con espaciadores dorados y un gran dije de corazón de acero inoxidable (stainless steel) de diseño removible.',
    material: 'Cuentas planas magenta y dije de corazón de acero inoxidable (stainless steel)',
  ...
  },
  {
    ...
    name: 'Ancla del Alma',
    price: 45.00,
    description: 'Collar de cuentas negras mate con espaciadores celestes brillantes y un dije de cangrejo de acero inoxidable (stainless steel) de diseño desmontable.',
    material: 'Cuentas de resina negra mate, cuentas semilla celestes y dije de cangrejo de acero inoxidable (stainless steel)',
  ...
  },
  {
    ...
    name: 'Pacto Eterno',
    price: 56.00,
    description: 'Elegante collar de cuentas de acrílico color verde brillante esmeralda con un aro grande dorado en forma de C gruesa de latón como dije removible.',
    material: 'Cuentas de acrílico verde brillante y dije de aro de latón grueso dorado',
  ...
  {
    id: 'cielo-nuevo',
    name: 'Cielo Nuevo / Bruma Estelar',
    price: 50.00,
    description: 'Hermoso collar de cuentas de resina azul iridiscente con espaciadores rosa pálido y un gran dije de flor de cinco pétalos dorados con una pequeña perla colgante. Al ser un diseño dos en uno, puedes usarlo con su dije de flor o sin él para un estilo clásico de cuentas continuas.',
    material: 'Cuentas iridiscentes de resina azul, perla de río y flor de latón dorado',
